...
from calc.vacc_plots import plot_with_daily_cases, plot_without_daily_cases, plot_with_daily_cases_updated
from cythonsim import model
from tqdm import tqdm
from datetime import datetime, date, timedelta
from calc.vacc_scenarios import VaccinationScenarioCV_updated, VaccinationScenarioCV_updated_more
...
def run_simulation(scenarios, vacc_stages, delta_days=210, save=False, debug=False):
    ...
    for scenario_name, scenario in scenarios.items():
        for vacc_plan_name, vacc_plan in vacc_stages.items():
            ...
            plt = plot_with_daily_cases_updated(df, debug=debug) # ALC with
            plt.tight_layout()
...
if __name__ == '__main__':
    ...
    scenarios = {
        'Updated': VaccinationScenarioCV_updated_more(start_date=start_date)
    }
    ...
    run_simulation(scenarios, vacc_stages, delta_days=100, save=True, debug=False)

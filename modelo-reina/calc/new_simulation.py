...
def simulate_individuals(variables, time_delta=7, step_callback=None):
    pc = PerfCounter()
    ...
    end_day = datetime.now() + timedelta(days=time_delta)
    # end_day = datetime.now() + timedelta(days=220)
...
if __name__ == '__main__':
    ...
    scenario.apply()
    df = simulate_individuals(time_delta=21, step_callback=step_callback, skip_cache=True)
